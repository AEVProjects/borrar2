-- ============================================================
-- Migration v2: Update Business Line Names & Contexts
-- Run this if you already ran migration-business-lines-redesign.sql
-- Safe to run multiple times (uses slug as stable identifier)
-- ============================================================

-- ──────────────────────────────────────────────────────────────────
-- 1. AI → AI & Smart Business
-- ──────────────────────────────────────────────────────────────────
UPDATE public.business_lines SET
  name = 'AI & Smart Business',
  description = 'AI automation, data-driven insights & custom AI solutions for measurable business performance',
  context_text = 'MSI Technologies AI & Smart Business Practice
...
-- ──────────────────────────────────────────────────────────────────
-- 2. WFA — update context (name unchanged)
-- ──────────────────────────────────────────────────────────────────
UPDATE public.business_lines SET
  description = 'Talent optimization, flexible workforce models & employee upskilling for a future-ready organization',
  context_text = 'MSI Technologies Workforce Agility Practice
...
-- ──────────────────────────────────────────────────────────────────
-- 3. NPO → Network Performance Optimization
-- ──────────────────────────────────────────────────────────────────
UPDATE public.business_lines SET
  name = 'Network Performance Optimization',
  description = 'Elite network efficiency using cost-effective nearshore LATAM engineering talent aligned to U.S. hours',
  context_text = 'MSI Technologies Network Performance Optimization Practice
...
-- ──────────────────────────────────────────────────────────────────
-- 4. A&E → Architecture & Engineering Solutions
-- ──────────────────────────────────────────────────────────────────
UPDATE public.business_lines SET
  name = 'Architecture & Engineering Solutions',
  description = 'Rapid A&E team scaling with nearshore MEP, BIM, civil & structural talent aligned to U.S. standards',
  context_text = 'MSI Technologies Architecture & Engineering Solutions Practice
...
-- ──────────────────────────────────────────────────────────────────
-- 5. IT — update context (name unchanged)
-- ──────────────────────────────────────────────────────────────────
UPDATE public.business_lines SET
  description = 'IT outsourcing, cloud computing, cybersecurity & digital strategy — full-stack IT partner',
  context_text = 'MSI Technologies IT Solutions Practice
