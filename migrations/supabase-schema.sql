...
-- ============================================================
-- FOLLOWERS TABLE
-- Stores LinkedIn followers data
-- ============================================================
...
CREATE INDEX idx_followers_nombre ON public.followers(nombre);
CREATE INDEX idx_followers_grado ON public.followers(grado_conexion);
CREATE INDEX idx_followers_fecha ON public.followers(fecha_seguimiento);
CREATE INDEX idx_followers_created ON public.followers(created_at DESC);
