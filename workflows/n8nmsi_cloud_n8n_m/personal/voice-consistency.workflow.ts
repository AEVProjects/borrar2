...
// Nodes   : 15  |  Connections: 13
//
// NODE INDEX
// ──────────────────────────────────────────────────────────────────
// Property name                    Node type (short)         Flags
// WebhookVoiceVideo                  webhook
// FormatVideoInput                   code
// AgentVoiceVideoScript              agent                      [AI]
// GoogleGeminiChatModel              lmChatGoogleGemini         [creds]
// BuildSettings                      code
// DownloadImage                      code
// SubmitPart1ImageToVideo            code
// WaitPart1                          wait
// FetchPart1                         code
// SubmitPart2VideoExtension          code
// WaitPart2                          wait
// FetchPart2                         code
// SignUrls                           code
...
// WebhookVoiceVideo
//    → FormatVideoInput
//      → AgentVoiceVideoScript
//        → BuildSettings
//          → DownloadImage
//            → SubmitPart1ImageToVideo
//              → WaitPart1
//                → FetchPart1
//                  → SubmitPart2VideoExtension
//                    → WaitPart2
//                      → FetchPart2
//                        → SignUrls
//                          → UpdateDb
...
//
// AI CONNECTIONS
// GoogleGeminiChatModel.uses({ ai_languageModel: AgentVoiceVideoScript })
// </workflow-map>
...
export class VoiceConsistencyWorkflow {
    // =====================================================================
    ...
    @links()
    defineRouting() {
        this.WebhookVoiceVideo.out(0).to(this.FormatVideoInput.in(0));
        this.FormatVideoInput.out(0).to(this.AgentVoiceVideoScript.in(0));
        this.AgentVoiceVideoScript.out(0).to(this.BuildSettings.in(0));
        this.BuildSettings.out(0).to(this.DownloadImage.in(0));
        this.DownloadImage.out(0).to(this.SubmitPart1ImageToVideo.in(0));
        this.SubmitPart1ImageToVideo.out(0).to(this.WaitPart1.in(0));
        this.WaitPart1.out(0).to(this.FetchPart1.in(0));
        this.FetchPart1.out(0).to(this.SubmitPart2VideoExtension.in(0));
        this.SubmitPart2VideoExtension.out(0).to(this.WaitPart2.in(0));
        ...
        this.AgentVoiceVideoScript.uses({
