...
// <workflow-map>
// Workflow : Video Job Worker
// Nodes   : 3  |  Connections: 2
//
// NODE INDEX
// ──────────────────────────────────────────────────────────────────
// Property name                    Node type (short)         Flags
// WebhookVideoJob                    webhook
// ProcessJob                         code
...
export class VideoJobWorkerWorkflow {
    // =====================================================================
    ...
    @links()
    defineRouting() {
        this.WebhookVideoJob.out(0).to(this.ProcessJob.in(0));
        this.ProcessJob.out(0).to(this.Respond.in(0));
    }
}
