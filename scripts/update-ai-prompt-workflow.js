...
promptLines.push('');
promptLines.push('**Email 1 (Sent immediately) - WORKSHOP INTRO + VALUE HOOK:**');
promptLines.push('Goal: Establish credibility and relevance. Open with something specific about their company, role, industry challenge, tech stack, or growth trajectory. Then introduce MSI\\'s AI Discovery Workshop as the focused next step: a 4-week engagement that helps them identify where AI can create value, validate readiness, and quantify ROI before committing to a PoC. Make the workshop the only offer. End with a soft, low-commitment CTA asking whether it makes sense to explore the workshop.');
...
promptLines.push('6. SUBJECT LINE: Only subject1 matters. Under 50 chars, deeply personalized, use normal sentence case capitalization (not all lowercase), and no clickbait. subject2 and subject3 MUST be empty strings so Apollo can thread them automatically.');
