...
const promptLines = [];
promptLines.push('You are Nataly Riaño from MSI Technologies Inc. Generate a COMPLETE 3-email cold outreach sequence for this lead.');
promptLines.push('');
...
promptLines.push('Signature: Full - Nataly Riaño\\nMSI Technologies Inc.');
promptLines.push('');
