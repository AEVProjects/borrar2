...
const serviceType = webhookData.service_type || 'Workshop';
...
promptLines.push('');
if (serviceType === 'Workforce Agility') {
  promptLines.push('=== WORKFORCE AGILITY ===');
  promptLines.push('- Offer: Workforce Agility adapt, evolve & excel in a changing market Talent Optimization Flexible Workforce Employee Upskilling We help you build a future-ready workforce by fostering adaptability, innovation, and efficiency.');
  promptLines.push('');
  promptLines.push('=== CRITICAL: WORKFORCE AGILITY FOCUS ONLY ===');
  promptLines.push('IMPORTANT: ALL 3 emails MUST focus exclusively on the Workforce Agility services.');
  promptLines.push('- Do NOT mention any other MSI services.');
  promptLines.push('- Every email must position Workforce Agility, Talent Optimization, and Upskilling as the single offer.');
  promptLines.push('- If you reference MSI credibility, keep it brief and only to support the workforce offer.');
  promptLines.push('');
  ...
  promptLines.push('**Email 1 (Sent immediately) - WORKFORCE AGILITY INTRO:**');
  promptLines.push('Goal: Focus on Talent Optimization and creating a Flexible Workforce. Open with a targeted problem regarding ' + (ctx.company || 'their company') + ' adapting their talent to a changing market. Transition fast to Workforce Agility upskilling.');
  promptLines.push('Tone: Assumptive language. Confident, no passive words.');
  ...
  promptLines.push('**Email 2 (Sent +3 days, REPLY in same thread) - INNOVATION HOOK:**');
  promptLines.push('Goal: They saw Email 1 but did not reply. Shift focus to innovation, employee retention, and operational efficiency through workforce agility.');
  promptLines.push('Tone: Assumptive and concise. Ask a low-friction binary question.');
  promptLines.push('Length: Limit to 60-70 words maximum. Punchy.');
  ...
  promptLines.push('Goal: Acknowledge silence. State that you are assuming workforce evolution isn\'t a current priority, so you will close their file.');
  ...
  promptLines.push('2. NARRATIVE ARC: Intro -> Innovation Hook -> Loss Aversion Breakup. Each email advances a very distinct stage.');
  ...
  promptLines.push('5. THE PITCH: Frame Workforce Agility as the ultimate future-proofing strategy for human capital.');
} else {
  if (serviceType === 'Workforce Agility') {
  promptLines.push('=== WORKFORCE AGILITY ===');
  promptLines.push('- Offer: Workforce Agility adapt, evolve & excel in a changing market Talent Optimization Flexible Workforce Employee Upskilling We help you build a future-ready workforce by fostering adaptability, innovation, and efficiency.');
